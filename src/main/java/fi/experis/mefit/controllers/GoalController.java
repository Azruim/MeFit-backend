...
public class GoalController {
    ...
    @GetMapping("/{goalId}")
    public ResponseEntity<GetGoalDTO> getGoalById(@Parameter(description = "Id of goal to be searched") @PathVariable Long goalId) {
        return goalService.getGoalById(goalId);
    }

    @Operation(summary = "Create a new goal")
    @PostMapping
    public ResponseEntity<String> addGoal(@RequestBody CreateGoalDTO goal) {
        return goalService.addGoal(goal);
    }

    @Operation(summary = "Update goal by id")
    @PatchMapping("/{goalId}")
    public ResponseEntity<String> updateGoal(@Parameter(description = "Id of goal to be updated") @PathVariable Long goalId, @RequestBody CreateGoalDTO goal) {
